        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link " href="profile">
                    ...
                    <span class="nav-link-text ms-1">Manage profile</span>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
                <a href="../pages/salemanagement.html" class="card">
            ...
            <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
                <a href="../pages/accountmanagement.html" class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
            ...
            <div class="col-xl-4 col-sm-6">
                <a href="../pages/productmanagement.html" class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
