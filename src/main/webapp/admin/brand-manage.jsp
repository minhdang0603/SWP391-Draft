                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active profile-overview pt-3">
                                <div class="container">
                                    <form id="categoryForm" method="post" action="${contextPath}/admin/brand-add"
                                          onsubmit="return validateFileType()" oninput="validateForm()"
                                    >
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row mb-3">
                                                    <label for="brandName" class="col-md-4 col-form-label">Tên hãng sản phẩm
                                                    </label>
                                                    <div class="col-md-8">
                                    ...
                                    <table id="myTable"
                                        ...
                                        <c:forEach var="brand" items="${listBrand}">
                                            <tr>
                                                ...
                                                <td class="align-middle text-sm">${brand.brandName}</td>
                                                <td class="align-middle text-center text-sm mr-2"><a href="#"
                                                                                                     onclick="editModal('${brand.id}')">
                                                    <i
                                                            class="bi bi-pencil-square"
                                                            style="font-size: 20px; color: deepskyblue"></i></a></td>
                                                <td class="align-middle text-center text-sm mr-2"><a href="#"
                                                                                                     onclick="deleteModal('${brand.id}')"><i
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <p>Bạn có chắc chắn muốn xóa hãng sản phẩm này không?</p>
                                                        </div>
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="${contextPath}/admin/brand-delete?brandId=${brand.id}"
                                            ...
                                            <div class="modal" id="brandUpdateModal${brand.id}" tabindex="-1"
                                                 aria-labelledby="brandUpdatesModalLabel"
                                                 aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-scrollable modal-xl modal-dialog-centered"
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="brandUpdatesModalLabel">Chỉnh
                                                                Sửa Hãng Sản Phẩm</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form id="updateBrandForm"
                                                                  ...
                                                                  action="${contextPath}/admin/brand-update"
                                                                  method="post">
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            <label for="brandIDUpdate"><strong>Mã
                                                                                hãng sản phẩm
                                                                                :</strong></label>
                                                                            <input type="text"
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="brandNameUpdate"><strong>Tên
...
<script src="${contextPath}/assets/js/brand-manage.js"></script>
